...
CREATE TABLE `agent` (
  ...
  CONSTRAINT `fk_agent_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `representacionesDB`.`users` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_agent_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `representacionesDB`.`contact` (`id_contacto`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE `representation` (
  ...
  CONSTRAINT `fk_representation_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `representacionesDB`.`contact` (`id_contacto`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
...
CREATE TABLE `events` (
  ...
  CONSTRAINT `fk_events_representation1`
    FOREIGN KEY (`representation_id`)
    REFERENCES `representacionesDB`.`representation` (`id_representation`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_events_zip1`
    FOREIGN KEY (`zip_id`)
    REFERENCES `representacionesDB`.`zip` (`id_zip`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_events_address1`
    FOREIGN KEY (`address_id`)
    REFERENCES `representacionesDB`.`address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE `enterprise` (
  ...
  CONSTRAINT `fk_enterprise_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `representacionesDB`.`contact` (`id_contacto`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_enterprise_zip1`
    FOREIGN KEY (`zip_id`)
    REFERENCES `representacionesDB`.`zip` (`id_zip`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
...
CREATE TABLE `attended` (
  ...
  CONSTRAINT `fk_attended_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `representacionesDB`.`contact` (`id_contacto`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_attended_enterprise1`
    FOREIGN KEY (`enterprise_id`)
    REFERENCES `representacionesDB`.`enterprise` (`id_enterprise`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_attended_zip1`
    FOREIGN KEY (`zip_id`)
    REFERENCES `representacionesDB`.`zip` (`id_zip`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_attended_address1`
    FOREIGN KEY (`address_id`)
    REFERENCES `representacionesDB`.`address` (`id_address`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE `beneficiaries` (
  ...
  CONSTRAINT `fk_events_has_enterprise_events1`
    FOREIGN KEY (`events_id`)
    REFERENCES `representacionesDB`.`events` (`id_event`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_events_has_enterprise_enterprise1`
    FOREIGN KEY (`enterprise_id`)
    REFERENCES `representacionesDB`.`enterprise` (`id_enterprise`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
...
CREATE TABLE `attention` (
  ...
  CONSTRAINT `fk_representation_has_attended_representation1`
    FOREIGN KEY (`representation_id`)
    REFERENCES `representacionesDB`.`representation` (`id_representation`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_representation_has_attended_attended1`
    FOREIGN KEY (`attended_id`)
    REFERENCES `representacionesDB`.`attended` (`id_attended`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE `office` (
  ...
  CONSTRAINT `fk_representation_has_agent_representation1`
    FOREIGN KEY (`representation_id`)
    REFERENCES `representacionesDB`.`representation` (`id_representation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_representation_has_agent_agent1`
    FOREIGN KEY (`agent_id`)
    REFERENCES `representacionesDB`.`agent` (`id_agent`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_office_zip1`
    FOREIGN KEY (`zip_id`)
    REFERENCES `representacionesDB`.`zip` (`id_zip`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
